...
export const developerProjects: DeveloperProject[] = [
  {
    ...
    imagePath: require("./photos/pokemon-next-app.png")
  },
  {
    ...
    imagePath: require("./photos/tech-thursday-project.png")
  },
  {
    ...
    imagePath: require("./photos/dating-rest-api-postman-docs.png")
  }
]
